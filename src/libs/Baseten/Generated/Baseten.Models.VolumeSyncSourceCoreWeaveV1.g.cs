...
namespace Baseten
{
    ...
    public sealed partial class VolumeSyncSourceCoreWeaveV1
    {
        ...
        /// <summary>
        /// CoreWeave object storage source type.
        /// </summary>
        /// <default>"COREWEAVE"</default>
        [global::System.Text.Json.Serialization.JsonPropertyName("type")]
        public string Type { get; set; } = "COREWEAVE";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VolumeSyncSourceCoreWeaveV1" /> class.
        /// </summary>
        /// <param name="uri">
        /// Remote source URI to materialize into the destination volume.
        /// </param>
...
#endif
        public VolumeSyncSourceCoreWeaveV1(
            string uri,
        ...
        /// <summary>
        /// Creates a new <see cref="VolumeSyncSourceCoreWeaveV1"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static VolumeSyncSourceCoreWeaveV1 FromUri(string uri)
        {
            return new VolumeSyncSourceCoreWeaveV1
            {
                Uri = uri,
            };
        }
