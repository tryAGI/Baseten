...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        {
            var __response = await EditModelsByModelIdDeploymentsByDeploymentIdAutoscalingSettingsAsResponseAsync(
                modelId: modelId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editModelsByModelIdDeploymentsByDeploymentIdAutoscalingSettings",
                                methodName: "EditModelsByModelIdDeploymentsByDeploymentIdAutoscalingSettingsAsync",
                                pathTemplate: "$\"/v1/models/{modelId}/deployments/{deploymentId}/autoscaling_settings\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
