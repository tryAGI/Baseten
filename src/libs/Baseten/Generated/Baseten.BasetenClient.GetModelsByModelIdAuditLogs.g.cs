...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement s_GetModelsByModelIdAuditLogsSecurityRequirement0 =
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement[] s_GetModelsByModelIdAuditLogsSecurityRequirements =
            new global::Baseten.EndPointSecurityRequirement[]
            {                s_GetModelsByModelIdAuditLogsSecurityRequirement0,
            };
        partial void PrepareGetModelsByModelIdAuditLogsArguments(
            ...
            int? endEpochMillis,
            ref string modelId);
        partial void PrepareGetModelsByModelIdAuditLogsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? endEpochMillis,
            string modelId);
        partial void ProcessGetModelsByModelIdAuditLogsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetModelsByModelIdAuditLogsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Gets the audit log for a model<br/>
        ...
        /// <remarks>
        /// curl --request GET \<br/>
        /// --url https://api.baseten.co/v1/models/{model_id}/audit_logs \<br/>
        /// --header "Authorization: Bearer $BASETEN_API_KEY"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.ListAuditLogsResponseV1> GetModelsByModelIdAuditLogsAsync(
            string modelId,
        ...
        {
            var __response = await GetModelsByModelIdAuditLogsAsResponseAsync(
                modelId: modelId,
                cursor: cursor,
                limit: limit,
                direction: direction,
        ...
        /// --header "Authorization: Bearer $BASETEN_API_KEY"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.AutoSDKHttpResponse<global::Baseten.ListAuditLogsResponseV1>> GetModelsByModelIdAuditLogsAsResponseAsync(
            string modelId,
            string? cursor = default,
            int? limit = default,
            global::Baseten.AuditLogSortDirectionV1? direction = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetModelsByModelIdAuditLogsArguments(
            ...
            var __authorizations = global::Baseten.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetModelsByModelIdAuditLogsSecurityRequirements,
                operationName: "GetModelsByModelIdAuditLogsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Baseten.PathBuilder(
                                path: $"/v1/models/{modelId}/audit_logs",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetModelsByModelIdAuditLogsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getModelsByModelIdAuditLogs",
                                methodName: "GetModelsByModelIdAuditLogsAsync",
                                pathTemplate: "$\"/v1/models/{modelId}/audit_logs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetModelsByModelIdAuditLogsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetModelsByModelIdAuditLogsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
