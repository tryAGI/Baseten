...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement s_CreateTeamsByTeamIdApiKeysSecurityRequirement0 =
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement[] s_CreateTeamsByTeamIdApiKeysSecurityRequirements =
            new global::Baseten.EndPointSecurityRequirement[]
            {                s_CreateTeamsByTeamIdApiKeysSecurityRequirement0,
            };
        partial void PrepareCreateTeamsByTeamIdApiKeysArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string teamId,
            global::Baseten.CreateAPIKeyRequestV1 request);
        partial void PrepareCreateTeamsByTeamIdApiKeysRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string teamId,
            global::Baseten.CreateAPIKeyRequestV1 request);
        partial void ProcessCreateTeamsByTeamIdApiKeysResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTeamsByTeamIdApiKeysResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// }'
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.APIKeyV1> CreateTeamsByTeamIdApiKeysAsync(
            string teamId,
        ...
        {
            var __response = await CreateTeamsByTeamIdApiKeysAsResponseAsync(
                teamId: teamId,
        ...
        /// }'
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.AutoSDKHttpResponse<global::Baseten.APIKeyV1>> CreateTeamsByTeamIdApiKeysAsResponseAsync(
            string teamId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTeamsByTeamIdApiKeysArguments(
            ...
            var __authorizations = global::Baseten.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTeamsByTeamIdApiKeysSecurityRequirements,
                operationName: "CreateTeamsByTeamIdApiKeysAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createTeamsByTeamIdApiKeys",
                                methodName: "CreateTeamsByTeamIdApiKeysAsync",
                                pathTemplate: "$\"/v1/teams/{teamId}/api_keys\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTeamsByTeamIdApiKeysResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTeamsByTeamIdApiKeysResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Baseten.APIKeyV1.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Baseten.AutoSDKHttpResponse<global::Baseten.APIKeyV1>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Baseten.APIKeyV1.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
