...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        {
            var __response = await GetChainsByChainIdDeploymentsByChainDeploymentIdAsResponseAsync(
                chainId: chainId,
        ...
        /// --header "Authorization: Bearer $BASETEN_API_KEY"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.AutoSDKHttpResponse<global::Baseten.ChainDeploymentV1>> GetChainsByChainIdDeploymentsByChainDeploymentIdAsResponseAsync(
            string chainId,
            string chainDeploymentId,
            global::Baseten.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getChainsByChainIdDeploymentsByChainDeploymentId",
                                methodName: "GetChainsByChainIdDeploymentsByChainDeploymentIdAsync",
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Baseten.ChainDeploymentV1.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Baseten.AutoSDKHttpResponse<global::Baseten.ChainDeploymentV1>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Baseten.ChainDeploymentV1.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
