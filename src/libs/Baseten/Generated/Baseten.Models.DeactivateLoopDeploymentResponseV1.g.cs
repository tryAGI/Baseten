...
namespace Baseten
{
    ...
    {
        /// <summary>
        /// The deactivated loop deployment ID.
        /// </summary>
        ...
        /// <summary>
        /// The base model whose loop deployment was deactivated.
        /// </summary>
        ...
        /// <summary>
        /// The user who owned the loop deployment.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeactivateLoopDeploymentResponseV1" /> class.
        /// </summary>
        /// <param name="id">
        /// The deactivated loop deployment ID.
        /// </param>
...
#endif
        public DeactivateLoopDeploymentResponseV1(
            string id,
            string baseModel,
