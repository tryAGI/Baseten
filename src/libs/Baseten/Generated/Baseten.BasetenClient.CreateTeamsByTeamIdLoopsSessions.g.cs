...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement s_CreateTeamsByTeamIdLoopsSessionsSecurityRequirement0 =
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement[] s_CreateTeamsByTeamIdLoopsSessionsSecurityRequirements =
            new global::Baseten.EndPointSecurityRequirement[]
            {                s_CreateTeamsByTeamIdLoopsSessionsSecurityRequirement0,
            };
        partial void PrepareCreateTeamsByTeamIdLoopsSessionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string teamId);
        partial void PrepareCreateTeamsByTeamIdLoopsSessionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string teamId);
        partial void ProcessCreateTeamsByTeamIdLoopsSessionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTeamsByTeamIdLoopsSessionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.CreateLoopsSessionResponseV1> CreateTeamsByTeamIdLoopsSessionsAsync(
            string teamId,
            global::Baseten.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateTeamsByTeamIdLoopsSessionsAsResponseAsync(
                teamId: teamId,
        ...
        /// --header "Authorization: Bearer $BASETEN_API_KEY"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.AutoSDKHttpResponse<global::Baseten.CreateLoopsSessionResponseV1>> CreateTeamsByTeamIdLoopsSessionsAsResponseAsync(
            string teamId,
            global::Baseten.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTeamsByTeamIdLoopsSessionsArguments(
            ...
            var __authorizations = global::Baseten.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTeamsByTeamIdLoopsSessionsSecurityRequirements,
                operationName: "CreateTeamsByTeamIdLoopsSessionsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Baseten.PathBuilder(
                                path: $"/v1/teams/{teamId}/loops/sessions",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTeamsByTeamIdLoopsSessionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createTeamsByTeamIdLoopsSessions",
                                methodName: "CreateTeamsByTeamIdLoopsSessionsAsync",
                                pathTemplate: "$\"/v1/teams/{teamId}/loops/sessions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTeamsByTeamIdLoopsSessionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTeamsByTeamIdLoopsSessionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
