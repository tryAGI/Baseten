...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement s_GetTrainingProjectsSecurityRequirement0 =
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement[] s_GetTrainingProjectsSecurityRequirements =
            new global::Baseten.EndPointSecurityRequirement[]
            {                s_GetTrainingProjectsSecurityRequirement0,
            };
        partial void PrepareGetTrainingProjectsArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetTrainingProjectsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetTrainingProjectsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTrainingProjectsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetTrainingProjectsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTrainingProjectsArguments(
                httpClient: HttpClient);


            var __authorizations = global::Baseten.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetTrainingProjectsSecurityRequirements,
                operationName: "GetTrainingProjectsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTrainingProjectsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getTrainingProjects",
                                methodName: "GetTrainingProjectsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTrainingProjectsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTrainingProjectsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Baseten.ListTrainingProjectsResponseV1.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Baseten.AutoSDKHttpResponse<global::Baseten.ListTrainingProjectsResponseV1>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Baseten.ListTrainingProjectsResponseV1.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
