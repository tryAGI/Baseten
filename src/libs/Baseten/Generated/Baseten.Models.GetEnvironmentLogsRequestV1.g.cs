...
{
    /// <summary>
    /// A request to fetch logs for a model environment.<br/>
    /// Returns logs from every deployment that was active on the environment over<br/>
    ...
    public sealed partial class GetEnvironmentLogsRequestV1
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEnvironmentLogsRequestV1" /> class.
        /// </summary>
...
#endif
        public GetEnvironmentLogsRequestV1(
