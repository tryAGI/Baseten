...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        {
            var __response = await CreateTrainingProjectsByTrainingProjectIdJobsByTrainingJobIdStopAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createTrainingProjectsByTrainingProjectIdJobsByTrainingJobIdStop",
                                methodName: "CreateTrainingProjectsByTrainingProjectIdJobsByTrainingJobIdStopAsync",
                                pathTemplate: "$\"/v1/training_projects/{trainingProjectId}/jobs/{trainingJobId}/stop\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Baseten.StopTrainingJobResponseV1.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Baseten.AutoSDKHttpResponse<global::Baseten.StopTrainingJobResponseV1>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Baseten.StopTrainingJobResponseV1.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
