...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement s_CreateTeamsByTeamIdLoopsRunsSecurityRequirement0 =
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement[] s_CreateTeamsByTeamIdLoopsRunsSecurityRequirements =
            new global::Baseten.EndPointSecurityRequirement[]
            {                s_CreateTeamsByTeamIdLoopsRunsSecurityRequirement0,
            };
        partial void PrepareCreateTeamsByTeamIdLoopsRunsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string teamId,
            global::Baseten.CreateLoopsRunRequestV1 request);
        partial void PrepareCreateTeamsByTeamIdLoopsRunsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string teamId,
            global::Baseten.CreateLoopsRunRequestV1 request);
        partial void ProcessCreateTeamsByTeamIdLoopsRunsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTeamsByTeamIdLoopsRunsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Creates a Loops run in a team<br/>
        ...
        /// }'
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.CreateLoopsRunResponseV1> CreateTeamsByTeamIdLoopsRunsAsync(
            string teamId,
        ...
        {
            var __response = await CreateTeamsByTeamIdLoopsRunsAsResponseAsync(
                teamId: teamId,
        ...
        /// }'
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.AutoSDKHttpResponse<global::Baseten.CreateLoopsRunResponseV1>> CreateTeamsByTeamIdLoopsRunsAsResponseAsync(
            string teamId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTeamsByTeamIdLoopsRunsArguments(
            ...
            var __authorizations = global::Baseten.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTeamsByTeamIdLoopsRunsSecurityRequirements,
                operationName: "CreateTeamsByTeamIdLoopsRunsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTeamsByTeamIdLoopsRunsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createTeamsByTeamIdLoopsRuns",
                                methodName: "CreateTeamsByTeamIdLoopsRunsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTeamsByTeamIdLoopsRunsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTeamsByTeamIdLoopsRunsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateTeamsByTeamIdLoopsRunsAsync(
                teamId: teamId,
                request: __request,
                requestOptions: requestOptions,
