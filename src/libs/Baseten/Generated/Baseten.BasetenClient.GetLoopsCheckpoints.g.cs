...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement s_GetLoopsCheckpointsSecurityRequirement0 =
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement[] s_GetLoopsCheckpointsSecurityRequirements =
            new global::Baseten.EndPointSecurityRequirement[]
            {                s_GetLoopsCheckpointsSecurityRequirement0,
            };
        partial void PrepareGetLoopsCheckpointsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? runId,
            ref string? baseModel,
            ref string? checkpointPath);
        partial void PrepareGetLoopsCheckpointsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? runId,
            string? baseModel,
            string? checkpointPath);
        partial void ProcessGetLoopsCheckpointsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetLoopsCheckpointsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetLoopsCheckpointsAsResponseAsync(
                runId: runId,
                baseModel: baseModel,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetLoopsCheckpointsArguments(
                httpClient: HttpClient,
                runId: ref runId,
                baseModel: ref baseModel,
                checkpointPath: ref checkpointPath);


            var __authorizations = global::Baseten.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetLoopsCheckpointsSecurityRequirements,
                operationName: "GetLoopsCheckpointsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("checkpoint_path", checkpointPath)
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetLoopsCheckpointsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getLoopsCheckpoints",
                                methodName: "GetLoopsCheckpointsAsync",
                                pathTemplate: "\"/v1/loops/checkpoints\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetLoopsCheckpointsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetLoopsCheckpointsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
