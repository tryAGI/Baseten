...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement s_GetGatewayEventsSecurityRequirement0 =
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement[] s_GetGatewayEventsSecurityRequirements =
            new global::Baseten.EndPointSecurityRequirement[]
            {                s_GetGatewayEventsSecurityRequirement0,
            };
        partial void PrepareGetGatewayEventsArguments(
            ...
            ref string? cursor);
        partial void PrepareGetGatewayEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Collections.Generic.IList<string>? externalEntityIds,
            string? cursor);
        partial void ProcessGetGatewayEventsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetGatewayEventsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.GatewayEventsResponseV1> GetGatewayEventsAsync(
        ...
        {
            var __response = await GetGatewayEventsAsResponseAsync(
                startTime: startTime,
                endTime: endTime,
                limit: limit,
                apiKeys: apiKeys,
        ...
        /// --header "Authorization: Bearer $BASETEN_API_KEY"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.AutoSDKHttpResponse<global::Baseten.GatewayEventsResponseV1>> GetGatewayEventsAsResponseAsync(
            global::System.DateTime? startTime = default,
            global::System.DateTime? endTime = default,
            int? limit = default,
            global::System.Collections.Generic.IList<string>? apiKeys = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetGatewayEventsArguments(
            ...
            var __authorizations = global::Baseten.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetGatewayEventsSecurityRequirements,
                operationName: "GetGatewayEventsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("external_entity_ids", externalEntityIds, delimiter: ",", explode: true)
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetGatewayEventsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetGatewayEventsAsync",
                                pathTemplate: "\"/v1/gateway/events\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetGatewayEventsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetGatewayEventsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Baseten.GatewayEventsResponseV1.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Baseten.AutoSDKHttpResponse<global::Baseten.GatewayEventsResponseV1>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Baseten.GatewayEventsResponseV1.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
