...
namespace Baseten
{
    ...
    public sealed partial class VolumeSyncSourceAzureV1
    {
        ...
        /// <summary>
        /// Azure Blob Storage source type.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VolumeSyncSourceAzureV1" /> class.
        /// </summary>
        /// <param name="uri">
        /// Remote source URI to materialize into the destination volume.
        /// </param>
...
#endif
        public VolumeSyncSourceAzureV1(
            string uri,
        ...
        /// <summary>
        /// Creates a new <see cref="VolumeSyncSourceAzureV1"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static VolumeSyncSourceAzureV1 FromUri(string uri)
        {
            return new VolumeSyncSourceAzureV1
            {
                Uri = uri,
            };
        }
