...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        {
            var __response = await CreateChainsByChainIdEnvironmentsByEnvNameChainletSettingsInstanceTypesUpdateAsResponseAsync(
                chainId: chainId,
                envName: envName,
        ...
        /// }'
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Baseten.AutoSDKHttpResponse<global::Baseten.UpdateChainletEnvironmentInstanceTypeResponseV1>> CreateChainsByChainIdEnvironmentsByEnvNameChainletSettingsInstanceTypesUpdateAsResponseAsync(
            string chainId,
            string envName,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createChainsByChainIdEnvironmentsByEnvNameChainletSettingsInstanceTypesUpdate",
                                methodName: "CreateChainsByChainIdEnvironmentsByEnvNameChainletSettingsInstanceTypesUpdateAsync",
                                pathTemplate: "$\"/v1/chains/{chainId}/environments/{envName}/chainlet_settings/instance_types/update\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Baseten.UpdateChainletEnvironmentInstanceTypeResponseV1.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Baseten.AutoSDKHttpResponse<global::Baseten.UpdateChainletEnvironmentInstanceTypeResponseV1>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Baseten.UpdateChainletEnvironmentInstanceTypeResponseV1.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
