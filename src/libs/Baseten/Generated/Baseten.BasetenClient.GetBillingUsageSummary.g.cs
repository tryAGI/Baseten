...
namespace Baseten
{
    public partial class BasetenClient
    {
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement s_GetBillingUsageSummarySecurityRequirement0 =
        ...
        private static readonly global::Baseten.EndPointSecurityRequirement[] s_GetBillingUsageSummarySecurityRequirements =
            new global::Baseten.EndPointSecurityRequirement[]
        ...
        partial void ProcessGetBillingUsageSummaryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Baseten.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetBillingUsageSummarySecurityRequirements,
                operationName: "GetBillingUsageSummaryAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Baseten.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetBillingUsageSummaryAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetBillingUsageSummaryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Baseten.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetBillingUsageSummaryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Baseten.UsageSummaryV1.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Baseten.AutoSDKHttpResponse<global::Baseten.UsageSummaryV1>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Baseten.UsageSummaryV1.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
