...
namespace Baseten
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Baseten.AutoSDKRetryOptions Retry { get; set; } = new global::Baseten.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Baseten.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Baseten.IAutoSDKHook>();
        ...
        public global::Baseten.AutoSDKClientOptions AddHook(
            global::Baseten.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Baseten.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Baseten.AutoSDKClientOptions UseAuthorizationProvider(
            global::Baseten.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Baseten.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Baseten.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Baseten.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Baseten.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Baseten.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Baseten.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Baseten.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Baseten.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Baseten.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Baseten.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Baseten.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Baseten.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Baseten.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Baseten.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Baseten.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Baseten.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Baseten.AutoSDKClientOptions clientOptions,
            global::Baseten.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Baseten.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Baseten.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Baseten.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Baseten.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Baseten.IAutoSDKHook, global::Baseten.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Baseten.AutoSDKHookContext context)
        {
