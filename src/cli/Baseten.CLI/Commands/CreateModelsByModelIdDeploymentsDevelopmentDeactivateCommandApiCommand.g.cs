...
internal static partial class CreateModelsByModelIdDeploymentsDevelopmentDeactivateCommandApiCommand
{
    ...
    {
        var command = new Command(@"create-models-by-model-id-deployments-development-deactivate", @"Deactivates a development deployment
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.CreateModelsByModelIdDeploymentsDevelopmentDeactivateAsync(
                                    modelId: modelId,
