...
internal static partial class GetChainsByChainIdEnvironmentsByEnvNameCommandApiCommand
{
    ...
    {
        var command = new Command(@"get-chains-by-chain-id-environments-by-env-name", @"Get a chain environment's details
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.GetChainsByChainIdEnvironmentsByEnvNameAsync(
                                    chainId: chainId,
                                    envName: envName,
