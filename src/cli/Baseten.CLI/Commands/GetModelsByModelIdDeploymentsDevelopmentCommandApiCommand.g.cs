...
internal static partial class GetModelsByModelIdDeploymentsDevelopmentCommandApiCommand
{
    ...
    {
        var command = new Command(@"get-models-by-model-id-deployments-development", @"Gets a model's development deployment
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.GetModelsByModelIdDeploymentsDevelopmentAsync(
                                    modelId: modelId,
