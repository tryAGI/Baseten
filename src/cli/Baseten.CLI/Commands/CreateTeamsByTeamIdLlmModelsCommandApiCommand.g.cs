...
internal static partial class CreateTeamsByTeamIdLlmModelsCommandApiCommand
{
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Baseten.CreateLLMModelRequestV1>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.CreateTeamsByTeamIdLlmModelsAsync(
                                    teamId: teamId,
                                    resources: resources,
                                    llmConfig: llmConfig,
