...
internal static partial class GetChainsByChainIdDeploymentsByChainDeploymentIdChainletsByChainletIdLogsCommandApiCommand
{
    ...
    private static Argument<string> ChainletId { get; } = new(
        name: @"chainlet-id")
    {
        Description = @"This is a missing parameter that was added automatically. Please check the OpenAPI spec.",
    };
...
Resolves the chainlet (by ID, scoped to the given chain deployment) to its underlying model deployment and returns its logs in the given time range.");
                        ...
                        command.Arguments.Add(ChainletId);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var chainletId = parseResult.GetRequiredValue(ChainletId);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.GetChainsByChainIdDeploymentsByChainDeploymentIdChainletsByChainletIdLogsAsync(
                                    chainId: chainId,
