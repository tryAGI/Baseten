...
internal static partial class CreateChainsByChainIdEnvironmentsByEnvNamePromoteCommandApiCommand
{
        ...
        name: @"--deployment-id")
    {
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Baseten.ChainDeploymentV1 value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Baseten.ChainDeploymentV1 value, ref string? text);
...
Promotes an existing chain deployment to an environment and returns the promoted chain deployment.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Baseten.PromoteToChainEnvironmentRequestV1>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.CreateChainsByChainIdEnvironmentsByEnvNamePromoteAsync(
                                    chainId: chainId,
                                    envName: envName,
