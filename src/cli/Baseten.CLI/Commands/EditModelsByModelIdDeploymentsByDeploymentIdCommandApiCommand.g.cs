...
internal static partial class EditModelsByModelIdDeploymentsByDeploymentIdCommandApiCommand
{
...
Updates the mutable fields of a deployment and returns the updated deployment.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Baseten.UpdateDeploymentRequestV1>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.EditModelsByModelIdDeploymentsByDeploymentIdAsync(
                                    modelId: modelId,
