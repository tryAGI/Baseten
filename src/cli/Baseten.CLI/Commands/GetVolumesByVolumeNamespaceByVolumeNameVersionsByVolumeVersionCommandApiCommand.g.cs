...
internal static partial class GetVolumesByVolumeNamespaceByVolumeNameVersionsByVolumeVersionCommandApiCommand
{
        ...
        name: @"volume-version")
    {
        Description = @"This is a missing parameter that was added automatically. Please check the OpenAPI spec.",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Baseten.VolumeVersionDetailV1 value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Baseten.VolumeVersionDetailV1 value, ref string? text);
