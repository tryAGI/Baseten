...
internal static partial class GetModelsByModelIdDeploymentsCommandApiCommand
{
        ...
        name: @"model-id")
    {
        Description = @"This is a missing parameter that was added automatically. Please check the OpenAPI spec.",
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Baseten.DeploymentsV1 value, ref string? text);
