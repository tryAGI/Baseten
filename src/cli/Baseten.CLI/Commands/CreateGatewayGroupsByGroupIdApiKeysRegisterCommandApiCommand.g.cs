...
internal static partial class CreateGatewayGroupsByGroupIdApiKeysRegisterCommandApiCommand
{
        ...
        name: @"--key")
    {
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Baseten.RegisterAPIKeyResponseV1 value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Baseten.RegisterAPIKeyResponseV1 value, ref string? text);
...
Registers a Gateway API key with provided value, name.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Baseten.RegisterAPIKeyRequestV1>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.CreateGatewayGroupsByGroupIdApiKeysRegisterAsync(
                                    groupId: groupId,
                                    name: name,
                                    key: key,
