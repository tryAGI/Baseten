...
internal static partial class EditModelsByModelIdDeploymentsDevelopmentAutoscalingSettingsCommandApiCommand
{
    ...
    {
        var command = new Command(@"edit-models-by-model-id-deployments-development-autoscaling-settings", @"Updates a development deployment's autoscaling settings
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.EditModelsByModelIdDeploymentsDevelopmentAutoscalingSettingsAsync(
                                    modelId: modelId,
