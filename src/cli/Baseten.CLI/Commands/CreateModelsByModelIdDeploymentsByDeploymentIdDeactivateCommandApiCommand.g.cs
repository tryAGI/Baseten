...
internal static partial class CreateModelsByModelIdDeploymentsByDeploymentIdDeactivateCommandApiCommand
{
    ...
    {
        var command = new Command(@"create-models-by-model-id-deployments-by-deployment-id-deactivate", @"Deactivates a deployment
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.CreateModelsByModelIdDeploymentsByDeploymentIdDeactivateAsync(
                                    modelId: modelId,
