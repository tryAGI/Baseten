...
internal static partial class EditModelsByModelIdDeploymentsByDeploymentIdRequestBackpressureSettingsCommandApiCommand
{
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var policy = CliRuntime.WasSpecified(parseResult, Policy) ? parseResult.GetValue(Policy) : (__requestBase is { } __PolicyBaseValue ? __PolicyBaseValue.Policy : default);
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);


                                var response = await client.EditModelsByModelIdDeploymentsByDeploymentIdRequestBackpressureSettingsAsync(
                                    modelId: modelId,
