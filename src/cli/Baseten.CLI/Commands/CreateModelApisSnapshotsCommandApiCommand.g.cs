...
internal static partial class CreateModelApisSnapshotsCommandApiCommand
{
...
Creates a model weight snapshot for the specified model and returns the snapshot.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var model = parseResult.GetRequiredValue(CreateModelWeightSnapshotRequestV1OptionSetOptions.Model);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.CreateModelApisSnapshotsAsync(
                                    model: model,
