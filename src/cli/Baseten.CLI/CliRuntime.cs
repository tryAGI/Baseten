...
namespace Baseten.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Baseten.CLI";
    private const string UserSecretApiKeyName = "BASETEN_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"BASETEN_API_KEY"];
    private const string CredentialFileDirectoryName = ".baseten";

    public static async global::System.Threading.Tasks.Task<global::Baseten.BasetenClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Baseten.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Baseten.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Baseten.BasetenClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Baseten.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Baseten.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Baseten.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Baseten.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("BASETEN_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Baseten.ApiException exception)
    {
        var builder = new StringBuilder();
